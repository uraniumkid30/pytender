...
PyTender never needs to log API keys. Provider implementations should redact credentials, set finite timeouts, reuse clients/connections, validate HTTPS endpoints, and avoid embedding secrets in exception messages or provenance metadata.
